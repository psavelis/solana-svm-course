...
size: 16:9
paginate: true
header: 'Solana SVM Study Topics'
footer: 'EVM to SVM Migration Guide'
---
...
- Review [TASKS.md](../docs/TASKS.md) for implementation details
- Explore the [architecture diagrams](../docs/diagrams/)

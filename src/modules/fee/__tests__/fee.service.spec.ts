...
describe('FeeService', () => {
  ...
  describe('getFeeRecommendations', () => {
    it('should return comprehensive fee recommendations', async () => {
    ...
    it('should handle different priority levels', async () => {
      ...
      expect(result.moderate.priorityFee).toBeGreaterThan(result.conservative.priorityFee);
      expect(result.aggressive.priorityFee).toBeGreaterThan(result.moderate.priorityFee);
    });
  });
  ...
  describe('estimateComputeUnits', () => {
    it('should estimate compute units for different instruction types', () => {
      ...
      const estimateMethod = (service as any).estimateComputeUnits.bind(service);
  ...
  describe('Network congestion detection', () => {
    it('should detect network congestion levels', async () => {
      ...
      const congestionMethod = (service as any).getNetworkCongestion.bind(service);

...
import { FeeOptimizationService, FeeOptimizationResult, UserFeePreferences } from './fee-optimization.service';
import { GetFeeEstimateDto, GetFeeRecommendationsDto, ValidateFeeDto, OptimizeFeeDto, GetHistoricalAnalysisDto } from './dto/fee.dto';
...
export class FeeController {
  ...
  @ApiOperation({ summary: 'Get comprehensive fee recommendations with multiple priority levels' })
  @ApiResponse({
    status: 201,
  ...
  @Get('market-stats')
  @ApiOperation({ summary: 'Get current fee market statistics and network load' })
  @ApiResponse({
    status: 200,
  ...
  @Post('optimize')
  @ApiOperation({ summary: 'Get optimized fee recommendations using advanced strategies' })
  @ApiResponse({
    status: 201,

...
export class CpiController {
  ...
  @ApiResponse({ status: 201, description: 'CPI instruction created successfully' })
  ...
  @ApiResponse({ status: 200, description: 'CPI instructions retrieved successfully' })
  ...
  @ApiResponse({ status: 201, description: 'CPI permission created successfully' })
  ...
  @ApiResponse({ status: 200, description: 'CPI permission updated successfully' })
  ...
  @ApiResponse({ status: 200, description: 'CPI history retrieved successfully' })
  ...
  @ApiResponse({ status: 200, description: 'DEX history retrieved successfully' })

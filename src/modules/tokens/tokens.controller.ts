...
export class TokensController {
  ...
  createTokenMint(
    @Body() body: { payerPrivateKey: string; decimals?: number; freezeAuthority?: string },
  ) {
  ...
  burnTokens(@Body() body: { ownerPrivateKey: string; mintAddress: string; amount: number }) {
    return this.tokensService.burnTokens(body.ownerPrivateKey, body.mintAddress, body.amount);
  }
  ...
  getOrCreateATA(
    @Body() body: { payerPrivateKey: string; mintAddress: string; ownerAddress: string },
  ) {
  ...
  getATA(@Param('mintAddress') mintAddress: string, @Param('ownerAddress') ownerAddress: string) {
  ...
  closeTokenAccount(
    @Body() body: { ownerPrivateKey: string; mintAddress: string; recipientAddress?: string },
  ) {
  ...
  revokeTokenDelegation(@Body() body: { ownerPrivateKey: string; mintAddress: string }) {
    return this.tokensService.revokeTokenDelegation(body.ownerPrivateKey, body.mintAddress);
  }
  ...
  revokeTokenApproval(@Body() body: { ownerPrivateKey: string; mintAddress: string }) {
    return this.tokensService.revokeTokenApproval(body.ownerPrivateKey, body.mintAddress);
  }

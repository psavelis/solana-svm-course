...
describe('TokensService', () => {
  ...
  describe('getTokenBalance', () => {
    ...
    it('should handle errors', async () => {
      ...
      await expect(service.getTokenBalance('invalid-owner', 'invalid-mint')).rejects.toThrow(
        'Failed to get token balance: Invalid address',
      );
    });
  });
  ...
  describe('createTokenMint', () => {
    ...
    it('should handle errors during mint creation', async () => {
      ...
      await expect(service.createTokenMint('invalid-payer', 9)).rejects.toThrow(
  ...
  describe('burnTokens', () => {
    it('should burn tokens from an account', async () => {
      ...
      const result = await service.burnTokens('cGF5ZXItcHJpdmF0ZS1rZXk=', 'mint-address', 500000);
  ...
  describe('getTokenSupply', () => {
    ...
    it('should handle supply lookup errors', async () => {
      ...
      await expect(service.getTokenSupply('invalid-mint')).rejects.toThrow('Account not found');
    });
  });
  ...
  describe('createNFTWithMetadata', () => {
    ...
    it('should handle NFT creation errors', async () => {
      ...
      await expect(service.createNFTWithMetadata('payer', 'Test', 'TNFT', 'uri')).rejects.toThrow(
        'NFT creation failed',
      );
    });
  });
  ...
  describe('verifyNFTOwnership', () => {
    it('should verify NFT ownership', async () => {
      ...
      const result = await service.verifyNFTOwnership('nft-mint-address', 'owner-address');
    ...
    it('should handle ownership verification errors', async () => {
      ...
      await expect(service.verifyNFTOwnership('nft-mint', 'owner')).rejects.toThrow(
        'Failed to verify NFT ownership: Token mint not found',
      );
    });
  });
  ...
  describe('cancelListing', () => {
    ...
    it('should throw error for non-owned listing', async () => {
      ...
      await expect(service.cancelListing('listing-id', 'seller-address')).rejects.toThrow(

...
describe('TokensController', () => {
  ...
  describe('findByMint', () => {
    it('should return token by mint address', async () => {
      ...
      expect(service.findByMint).toHaveBeenCalledWith('EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v');
      expect(result).toEqual(mockToken);
    });
  });
  ...
  describe('getTokenInfo', () => {
    it('should get token info from Solana', async () => {
      ...
      expect(service.getTokenInfo).toHaveBeenCalledWith('EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v');
  ...
  describe('getTokenBalance', () => {
    it('should get token balance for owner', async () => {
      ...
      const result = await controller.getTokenBalance('owner-address', 'EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v');

      expect(service.getTokenBalance).toHaveBeenCalledWith('owner-address', 'EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v');

...
export class SvmController {
  ...
  async queryPrograms(@Query() query: ProgramQueryDto): Promise<{ programs: Program[]; total: number }> {
  ...
  @ApiResponse({ status: 200, description: 'Program deployed successfully', type: Program })
  ...
  @ApiResponse({ status: 201, description: 'Program executed successfully', type: RuntimeExecution })
  ...
  @ApiResponse({ status: 201, description: 'Programs executed successfully', type: [RuntimeExecution] })
  ...
  @ApiResponse({ status: 200, description: 'Execution retrieved successfully', type: RuntimeExecution })
  ...
  async queryExecutions(@Query() query: RuntimeExecutionQueryDto): Promise<{ executions: RuntimeExecution[]; total: number }> {
  ...
  @ApiResponse({ status: 201, description: 'Gas meter created successfully', type: GasMeter })
  ...
  @ApiResponse({ status: 200, description: 'Gas meter retrieved successfully', type: GasMeter })
  ...
  @ApiResponse({ status: 200, description: 'Gas meters retrieved successfully' })
  async queryGasMeters(@Query() query: GasMeterQueryDto): Promise<{ meters: GasMeter[]; total: number }> {
    return this.svmService.queryGasMeters(query);
  }

  @Put('gas-meters/:id')
  @ApiOperation({ summary: 'Update gas meter' })
  @ApiResponse({ status: 200, description: 'Gas meter updated successfully', type: GasMeter })
  ...
  @ApiResponse({ status: 200, description: 'Gas meter reset successfully', type: GasMeter })
  ...
  @ApiResponse({ status: 200, description: 'Runtime info retrieved successfully' })
  ...
  @ApiResponse({ status: 200, description: 'Program stats retrieved successfully' })

...
export class CreateSvmTables1735512000006 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    // Drop foreign keys
    const runtimeExecutionsTable = await queryRunner.getTable('runtime_executions');
    ...
    await queryRunner.dropIndex('runtime_executions', 'IDX_runtime_executions_created_at');
    await queryRunner.dropIndex('runtime_executions', 'IDX_runtime_executions_status');
    await queryRunner.dropIndex('runtime_executions', 'IDX_runtime_executions_transaction_id');
    await queryRunner.dropIndex('runtime_executions', 'IDX_runtime_executions_program_id');

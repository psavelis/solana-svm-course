...
export class CreateCpiTables1735512000007 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.dropIndex(
      "cpi_invocations",
      "IDX_cpi_invocations_target_program_id",
    );
    await queryRunner.dropIndex(
      "cpi_invocations",
      "IDX_cpi_invocations_caller_program_id",
    );
    await queryRunner.dropIndex(
      "cpi_invocations",
      "IDX_cpi_invocations_transaction_id",
    );
    await queryRunner.dropIndex(
      "cpi_permissions",
      "IDX_cpi_permissions_account_id",
    );
    await queryRunner.dropIndex(
      "cpi_permissions",
      "IDX_cpi_permissions_granter_program_id",
    );
    await queryRunner.dropIndex(
      "cpi_permissions",
      "IDX_cpi_permissions_program_id",
    );
    await queryRunner.dropIndex(
      "cpi_instructions",
      "IDX_cpi_instructions_caller_program_id",
    );
    await queryRunner.dropIndex(
      "cpi_instructions",
      "IDX_cpi_instructions_program_id",
    );
